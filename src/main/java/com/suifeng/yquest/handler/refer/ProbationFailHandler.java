...
/**
 * 试用期未通过事件处理器：同步更新入职记录状态为试用期未通过
 */
@Slf4j
@Service
public class ProbationFailHandler implements ReferEventHandler {
    ...
    public ReferApplyEventEnum getEvent() {
        return ReferApplyEventEnum.PROBATION_FAIL;
    }

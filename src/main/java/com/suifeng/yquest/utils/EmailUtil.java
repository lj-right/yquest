...
public class EmailUtil {
    ...
    // 发件人邮箱地址
    private static final String emailAccount = "18973513695@163.com"; // 这个是普通163邮箱
    // 发件人邮箱授权码
    private static final String emailPassword = "NGNwr435B28YkGJ2"; //授权码
     ...
     * @param content 邮件内容
     */
    public static boolean sendEmailUtil(Set<String> emails, String title, String content) {
        // 未传收件人邮箱地址则直接返回
        ...
        try {
            ...
            message.setFrom(new InternetAddress(emailAccount, "YQuest", "UTF-8"));
